...
public:
	...
	static void parse(int argc, const char **argv, physics::settings_type & physics_settings, scene::settings_type & scene_settings, Helix::settings_type & helix_settings, std::string & input_file, std::string & output_file) {
